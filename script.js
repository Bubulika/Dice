...
var score=[0,0], currentScore=0, activePlayer=0, gameStatus=false, activePlayerPanel=document.querySelector('.player-0-pannel');
...
btnNew.addEventListener('click', function(){
    ...
    document.querySelector(".player-0-pannel .player-name").textContent='Player1';
    document.querySelector(".player-1-pannel .player-name").textContent='Player2';
